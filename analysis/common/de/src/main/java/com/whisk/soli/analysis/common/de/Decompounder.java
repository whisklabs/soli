...
public class Decompounder {
    ...
    public static Decompounder defaultInstance() throws IOException {
        InputStream kompvv = Decompounder.class.getResourceAsStream("/decompound/kompVVic.tree");
        InputStream kompvh = Decompounder.class.getResourceAsStream("/decompound/kompVHic.tree");
        InputStream gfred = Decompounder.class.getResourceAsStream("/decompound/grfExt.tree");
        return new Decompounder(kompvv, kompvh, gfred, 0.51);
    }
